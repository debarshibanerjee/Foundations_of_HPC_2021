...
for file in files:
    ...
    plt.plot(msgsize, time_estimated, label = "Time (usec) - Fitted", marker="+", markersize=8, color='green')
    plt.plot(msgsize, time, label = "Time (usec)", marker="o", markersize=6, color='purple')

// a simple 1-D example: each element receive the rank of the previous one, add its rank and send
// forward. taken somewhere on net and adapted. Final SUM is the sum of n-1 integers.
